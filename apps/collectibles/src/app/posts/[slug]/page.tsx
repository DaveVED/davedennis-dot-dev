...
async function fetchGitMdxData(slug: string): Promise<MDXRemoteSerializeResult & { frontmatter: Record<string, unknown> }> {
  const res = await fetch(`https://raw.githubusercontent.com/DaveVED/my-posts/master/posts/${slug}.mdx`);
